...
## read individually processed rna WT
...
## read A2XII8 KD with transferred labels and TGME49 IDs
...
saveRDS(S.O.integrated, "../Input/toxo_cdc/rds_ME49_59/S.O.integrated_rna_WT_AP2XII8KD_reference_rna_WT_transferred_lables_from_boot.rds")
